  ...
  guards: {
    ...
    */
    api: {
      ...
      | and the token. You are free to use any column name for storing the
      | foreignKey value.
      |
      */
      tokenProvider: {
      ...
      provider: {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | The identifier key is the unique key on the model. In most cases, it
        | is the primary key. However, you can use some other key too.
        |
        */
        identifierKey: 'id',
        ...
        | of the mentioned columns to find a user.
        |
        */
        uids: ['email'],
